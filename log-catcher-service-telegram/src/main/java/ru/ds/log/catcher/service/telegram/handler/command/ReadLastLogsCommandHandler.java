...
public class ReadLastLogsCommandHandler implements BotCommandHandler {
    ...
    static String LOGS_EMPTY_MESSAGE_SOURCE = "logs.error.empty";
    ...
    public void handle(LogCatcherTelegramBot bot, Update update) throws TelegramApiException {
        ...
        Page<LogEntity> logEntities = logService.find(LogSearchPayload.builder()
                .systemId(systemId)
                .typeIn(singletonList(LogType.ERROR))
    ...
    public boolean isApplicable(String message) {
        return message.equals(CommandValue.READ_LAST_ERROR_LOGS.getValue());
    }
}
